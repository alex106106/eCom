...
object PaymentsUtil {
    ...
    private fun gatewayTokenizationSpecification(): JSONObject {
        return JSONObject().apply {
            ...
            put("parameters", JSONObject(Constants.Constants.PAYMENT_GATEWAY_TOKENIZATION_PARAMETERS))
        }
    }
    ...
    private fun directTokenizationSpecification(): JSONObject {
        if (Constants.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY == "REPLACE_ME" ||
            (Constants.Constants.DIRECT_TOKENIZATION_PARAMETERS.isEmpty() ||
                    Constants.Constants.DIRECT_TOKENIZATION_PUBLIC_KEY.isEmpty())) {
        ...
        return JSONObject().apply {
            put("type", "DIRECT")
            put("parameters", JSONObject(Constants.Constants.DIRECT_TOKENIZATION_PARAMETERS))
        }
    }
     ...
     */
    private val allowedCardNetworks = JSONArray(Constants.Constants.SUPPORTED_NETWORKS)
     ...
     * @see [CardParameters](https://developers.google.com/pay/api/android/reference/object.CardParameters)
     */
    private val allowedCardAuthMethods = JSONArray(Constants.Constants.SUPPORTED_METHODS)
    ...
    fun createPaymentsClient(activity: Activity): PaymentsClient {
        val walletOptions = Wallet.WalletOptions.Builder()
            .setEnvironment(Constants.Constants.PAYMENTS_ENVIRONMENT)
            .build()
    ...
    private fun getTransactionInfo(price: String): JSONObject {
        return JSONObject().apply {
            ...
            put("countryCode", Constants.Constants.COUNTRY_CODE)
            put("currencyCode", Constants.Constants.CURRENCY_CODE)
        }
    }
